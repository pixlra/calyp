...
TEST_CASE( "Can open a YUV file", "CalypStream" )
{
  ...
  auto common_checks = []( auto& stream ) {
    return stream.getWidth() == kWidth &&
           stream.getHeight() == kHeight &&
           stream.getBitsPerPixel() == kBitsPel &&
           stream.getFormatName() == "YUV" &&
  ...
  SECTION( "YUV422p" )
  {
    constexpr auto kInputFormat{ CalypPixelFormats::CLP_YUV422P };
  ...
  SECTION( "YUV444p" )
  {
    constexpr auto kInputFormat{ CalypPixelFormats::CLP_YUV444P };
  ...
  SECTION( "YUYV422" )
  {
    constexpr auto kInputFormat{ CalypPixelFormats::CLP_YUYV422 };
...
TEST_CASE( "Can open a RGB file", "CalypStream" )
{
  ...
  SECTION( "RGB24" )
  {
    constexpr auto kInputFormat{ CalypPixelFormats::CLP_RGB24 };
  ...
  SECTION( "BGR24" )
  {
    constexpr auto kInputFormat{ CalypPixelFormats::CLP_BGR24 };
...
TEST_CASE( "Can open a GRAY file", "CalypStream" )
{
  ...
  constexpr auto kInputFormat{ CalypPixelFormats::CLP_GRAY };

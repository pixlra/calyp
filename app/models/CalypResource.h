...
/**
 * \file     CalypResource.h
 * \brief    Abstract calyp resource
 */

#ifndef __CALYPRESOURCE_H__
#define __CALYPRESOURCE_H__
...
{
public:
  virtual ~CalypResource() = default;

  virtual auto iteration() -> bool = 0;
